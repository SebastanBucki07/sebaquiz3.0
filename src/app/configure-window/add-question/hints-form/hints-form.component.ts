...
@Component({
  ...
  imports: [
    ...
    MatSelectModule, MatButtonModule, MatIconModule, MatSnackBarModule, MatSliderModule
  ],
...
export class HintsFormComponent implements OnInit {
  ...
  removeHint(index: number) { this.hints.removeAt(index); }
