export const TV_SERIES = [
  ...
  {
    id: 8,
    answers: [{ value: 'MIASTECZKO TWIN PEAKS' }],
    question: 'W sennym i spokojnym miasteczku zostaje odnalezione ciało uczennicy, Laury Palmer.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 9,
    answers: [{ value: 'HOUSE OF CARDS' }],
    question:
  ...
  {
    id: 14,
    answers: [{ value: 'PRZYJACIELE' }],
    question: 'Losy szóstki przyjaciół, którzy mieszkają i pracują w Nowym Jorku.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 15,
    answers: [{ value: 'DOM Z PAPIERU' }],
    question:
  ...
  {
    id: 24,
    answers: [{ value: 'SYNOWIE ANARCHII' }],
    question:
  ...
  {
    id: 28,
    answers: [{ value: 'AMERICAN HORROR STORY: ASYLUM' }],
    question:
      'Lana zamierza napisać artykuł o seryjnym mordercy kobiet, więc włamuje się do zakładu psychiatrycznego. Zostaje schwytana przez pracowników i uwięziona w placówce.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 29,
    answers: [{ value: 'JAK POZNAŁEM WASZĄ MATKĘ' }],
    question:
  ...
  {
    id: 30,
    answers: [{ value: 'SPARTAKUS: KREW I PIACH' }],
    question:
  ...
  },
  {
    id: 32,
    answers: [{ value: 'RZYM' }],
    question: 'Juliusz Cezar po zakończeniu wojny w Galii i jej podbiciu wraca do Rzymu.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 33,
    answers: [{ value: 'TEORIA WIELKIEGO PODRYWU' }],
    question:
  ...
  {
    id: 35,
    answers: [{ value: 'Z ARCHIWUM X' }],
    question: 'Dwójka agentów FBI pracuje w wydziale X zajmującym się zjawiskami paranormalnymi.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 36,
    answers: [{ value: 'EL CHAPO' }],
    question:
      'Serial oparty na prawdziwej historii wzlotów i upadków okrytego złą sławą meksykańskiego barona narkotykowego — Joaquína',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 37,
    answers: [{ value: 'THE WALKING DEAD' }],
    question:
  ...
  { id: 40, answers: [{ value: 'LOST' }], question: 'ZAGUBIENI', hints: [], revealedAnswers: [] },
  {
    id: 41,
    answers: [{ value: 'PAMIĘTNIKI WAMPIRÓW' }],
    question:
  ...
  {
    id: 43,
    answers: [{ value: 'WAMPIRY: DZIEDZICTWO' }],
    question:
  ...
  {
    id: 44,
    answers: [{ value: 'SHADOWHUNTERS' }],
    question:
      'Nastoletnia dziewczyna odkrywa, że pochodzi z rodu Nocnych Łowców. Jej przeznaczeniem jest chronić świat przed atakami demonów.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 45,
    answers: [{ value: 'CZYSTA KREW' }],
    question:
  ...
  {
    id: 46,
    answers: [{ value: 'SKAZANY NA SMIERĆ' }],
    question:
  ...
  {
    id: 47,
    answers: [{ value: 'SŁONECZNY PATROL' }],
    question: 'Ratownicy patrolują plaże w Los Angeles, dbając o bezpieczeństwo turystów.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 48,
    answers: [{ value: 'SKAZANA' }],
    question:
  ...
  {
    id: 54,
    answers: [{ value: 'KLANGOR' }],
    question: 'Gdy znika córka psychologa więziennego rozpoczyna on poszukiwania na własną rękę.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 55,
    answers: [{ value: 'ŚLEPNĄC OD ŚWIATEŁ' }],
    question:
  ...
  {
    id: 57,
    answers: [{ value: 'STULECIE WINNYCH' }],
    question:
      'Serial realizowany na motywach bestsellerowej, trzytomowej sagi Ałbeny Grabowskiej o tym samym tytule. Jest to pełna nieoczekiwanych zwrotów akcji opowieść o wielopokoleniowej rodzinie',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 58,
    answers: [{ value: 'OFICER' }],
    question:
  ...
  {
    id: 59,
    answers: [{ value: 'CZTEREJ PANCERNI I PIES' }],
    question:
  ...
  },
  {
    id: 61,
    answers: [{ value: 'KRÓL' }],
    question: '1937 rok. W Warszawie działa gang dowodzony przez Kuma Kaplicę i Jakuba Szapiro.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 62,
    answers: [{ value: '07 ZGŁOŚ SIĘ' }],
    question:
  ...
  {
    id: 64,
    answers: [{ value: 'O MNIE SIĘ NIE MARTW' }],
    question:
      'Iga jest samotną matką wychowującą dwójkę dzieci. Wkrótce kobieta poznaje młodego adwokata.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 65,
    answers: [{ value: 'CZTERDZIESTOLATEK' }],
    question:
  ...
  {
    id: 67,
    answers: [{ value: 'POD POWIERZCHNIĄ' }],
    question:
      'Bartek jest dyrektorem szanowanego liceum i wspólnie z Mart, nauczycielką języka polskiego, tworzą pozornie kochające się małżeństwo. Traumatyczne przejścia powodują, że para przeżywa poważny kryzys. Czy uda im się uratować swój związek przed rozpadem?',
    hints: [],
    revealedAnswers: [],
  },
  {
  ...
  {
    id: 69,
    answers: [{ value: 'SKAZANE' }],
    question:
      'Historia czterech kobiet, które odwiedzają zakład karny, gdzie przybywają ich bliscy.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 70,
    answers: [{ value: 'DIAGNOZA' }],
    question:
      'Czasem jedno nieoczekiwane wydarzenie może nieodwracalnie zmienić dotychczasowe życie. Co się stanie, jeśli pewnego dnia ockniesz się i odkryjesz, że nie wiesz, kim jesteś, kogo kochasz i na czym ci zależy? Czy los może być aż tak okrutny, by odebrać wszystko, nawet tożsamość i wspomnienia? Jak na nowo ułożyć puzzle życia, gdy brakuje podstawowych elementów układanki?',
    hints: [],
    revealedAnswers: [],
  },
  {
    ...
    answers: [{ value: 'ROJST' }],
    question:
      'Powódź stulecia” nawiedziła południowy zachód Polski latem 1997 roku. Woda zalewa część miasta odsłaniając zakopane w lesie ludzkie szczątki oraz ciało nastoletniego chłopca, który początkowo uznany zostaje za przypadkową ofiarę powodzi.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 72,
    answers: [{ value: 'PARADOKS' }],
    question:
  ...
  {
    id: 73,
    answers: [{ value: 'KOWALSCY KONTRA KOWALSCY' }],
    question:
  ...
  {
    id: 74,
    answers: [{ value: 'SINGIELKA' }],
    question: 'Historia Elki, która postanawia znaleźć prawdziwą miłość w 274 dni.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 75,
    answers: [{ value: 'ZAWSZE WARTO' }],
    question:
  ...
  },
  {
    id: 76,
    answers: [{ value: 'MOTYW' }],
    question: 'Każdy jest zdolny do zła, potrzebny jest tylko motyw.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 77,
    answers: [{ value: 'PRAWO AGATY' }],
    question:
  ...
  {
    id: 79,
    answers: [{ value: 'ŻYWIOŁY SASZY – OGIEŃ' }],
    question:
  ...
  },
  {
    id: 81,
    answers: [{ value: 'SZADŹ' }],
    question: 'Historia seryjnego mordercy oraz podążającej jego tropem komisarz policji.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 82,
    answers: [{ value: 'SEXIFY' }],
    question:
  ...
  {
    id: 85,
    answers: [{ value: 'MROCZNE POŻĄDANIE' }],
    question:
  ...
  {
    id: 98,
    answers: [{ value: 'RIVERDALLE' }],
    question:
      'W spokojnym miasteczku ginie nastolatek z wpływowej rodziny. Grupa przyjaciół próbuje rozwiązać zagadkę morderstwa.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 99,
    answers: [{ value: 'THE GOOD DOCTOR' }],
    question:
  ...
  {
    id: 100,
    answers: [{ value: 'SZKOŁA DLA ELITY' }],
    question:
  ...
  {
    id: 107,
    answers: [{ value: 'PIRACI' }],
    question:
      'Brytyjczycy chcą odzyskać swoją dawną kolonię, New Providence. Piraci, na czele z Kapitanem Flintem, walczą o przetrwanie nie tylko z najeźdźcą, ale także między sobą.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 108,
    answers: [{ value: 'DWÓCH I PÓŁ' }],
    question:
      'Świeżo rozwiedziony Alan Harper wprowadza się do mieszkania swojego brata – Charliego wraz z 10-letnim synem.',
    hints: [],
    revealedAnswers: [],
  },
  {
  ...
  {
    id: 110,
    answers: [{ value: 'UPADEK KRÓLESTWA' }],
    question:
  ...
  {
    id: 111,
    answers: [{ value: 'STRAŻNIK TEKSASU' }],
    question:
      'Cordell Walker walczy ze wszystkimi formami przestępczości w stanie Teksas. Pomagają mu w tym inni agenci na czele z Jimmym Trivettem',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 112,
    answers: [{ value: 'KOŁO CZASU' }],
    question:
      'Moiraine, przywódczyni organizacji kobiet o magicznych zdolnościach, wybiera pięć młodych osób, by wśród nich znaleźć tę, której jest pisane ocalenie lub zniszczenie świa',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 113,
    answers: [{ value: 'Resident Evil Remedium' }],
    question:
  ...
  {
    id: 114,
    answers: [{ value: 'ALL OF US ARE DEAD' }],
    question:
  ...
  {
    id: 115,
    answers: [{ value: 'PEWNEGO RAZU NA KRAJOWEJ JEDYNCE' }],
    question:
  ...
  {
    id: 118,
    answers: [{ value: 'MIŁOŚĆ, SEKS & PANDEMIA' }],
    question:
      'Pandemia zmienia wszystko. Oto trzy przyjaciółki – wyzwolona Kaja, Nora i zasadnicza feministka Olga, a do tego prawiczek Bartek, który chce zrobić karierę jako striptizer. Wybuch zarazy wywraca do góry nogami ich erotyczne oraz uczuciowe życie.',
    hints: [],
    revealedAnswers: [],
  },
  {
  ...
  {
    id: 122,
    answers: [{ value: 'WINCHESTEROWIE' }],
    question:
      'Przed Samem i Deanem byli ich rodzice. Opowiedziana z perspektywy Deana, epicka historia miłosna o tym, jak John Winchester poznał Mary Campbell i zaryzykował wszystko, aby nie tylko ocalić swoją miłość, ale i cały świat.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 123,
    answers: [{ value: 'ODWILŻ' }],
    question:
  ...
  {
    id: 126,
    answers: [{ value: 'Tajemnica zawodowa' }],
    question: 'Prawniczka Julia Żurawska walczy o oczyszczenie męża z zarzutów kryminalnych.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 127,
    answers: [{ value: 'Plotkara' }],
    question: 'Nowojorscy nastolatkowie wykorzystują media społecznościowe, by rozsiewać plotki.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 128,
    answers: [{ value: 'Archiwista' }],
    question:
  ...
  },
  {
    ...
    answers: [{ value: 'Forst' }],
    question:
      'Kiedy Tatry stają się areną brutalnych morderstw, komisarz [...] wkracza do akcji. Działając wbrew procedurom, z pomocą dziennikarki Olgi Szrebskiej, odkrywa spisek sięgający korzeniami',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 132,
    answers: [{ value: 'Śleboda' }],
    question:
      'Anka, antropolog kultury, wyjeżdża na Podhale, gdzie przypadkowo odkrywa zwłoki i zostaje wplątana w śledztwo dotyczące morderstwa. Jej losy splatają się z Bastianem, zuchwałym dziennikarzem,',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 133,
    answers: [{ value: 'Wzgórze psów' }],
    question:
  ...
  {
    id: 134,
    answers: [{ value: 'Idź przodem, bracie' }],
    question:
      'Po przejściu ataku paniki podczas ważnej akcji policyjnej członek elitarnej jednostki taktycznej musi opuścić służbę. Co gorsza, mężczyzna dowiaduje się, że jego ojciec popełnił samobójstwo,',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 135,
    answers: [{ value: 'Prosta sprawa' }],
    question:
      'Głównym protagonistą jest bezimienny mściciel z trudną przeszłością. Zależy mu na spłacie długu człowiekowi, który wiele lat temu, całkowicie bezinteresownie, pożyczył mu pieniądze,',
    hints: [],
    revealedAnswers: [],
  },
  {
    ...
    answers: [{ value: 'Senna' }],
    question:
      'Od dzieciństwa zafascynowany samochodami brazylijski kierowca wyścigowy Ayrton [...] królował na szczycie — do czasu tragedii, która na zawsze zmieniła Formułę 1.',
    hints: [],
    revealedAnswers: [],
  },
  {
    ...
    question:
      'Opowieść o bogactwie i nędzy w świecie, w którym nie ma już prawie nic do posiadania. 200 lat po jądrowej apokalipsie łagodni mieszkańcy luksusowych schronów przeciwatomowych zmuszeni',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 138,
    answers: [{ value: 'Szogun' }],
    question:
      'Kiedy w 1600 roku w Japonii Lord Yoshii Toranaga walczy o życie ze sprzymierzonymi przeciwko niemu wrogami z Rady Regentów, w pobliskiej wiosce rybackiej odnaleziony zostaje tajemniczy',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 139,
    answers: [{ value: 'Matki pingwinów' }],
    question:
  ...
  {
    id: 140,
    answers: [{ value: 'Pingwin' }],
    question:
      'Ośmielony śmiercią szefa mafii, Carminea Falconea, i falą przestępczości, Oswald “Oz” Cobb podejmuje działania, aby wypełnić próżnię pozostawioną na szczytach przestępczego półświatka',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 141,
    answers: [{ value: 'Stamtąd' }],
    question:
      'Jadąca na wakacje rodzina przypadkiem trafia do miasteczka, z którego nie ma wyjścia. Uwięzieni mieszkańcy niewielkiego miasteczka gorączkowo szukają sposobu na wydostanie się z niewytłumaczalnej',
    hints: [],
    revealedAnswers: [],
  },
  {
    ...
    answers: [{ value: '1670' }],
    question:
      'Jest rok [...]. Jan, głowa szlacheckiej rodziny i właściciel (mniejszej) połowy wsi Adamczycha, marzy o zapisaniu się na kartach historii Polski. Jego życie to pasmo sukcesów. Wszystko,',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 143,
    answers: [{ value: 'Informacja zwrotna' }],
    question:
  ...
  },
  {
    ...
    answers: [{ value: 'Pati' }],
    question:
      '[...] odsiedziała już pięć z ośmiu lat wyroku. Widzowie dowiedzą się, jak doszło do tego, że ich ulubiona osadzona trafiła do więzienia.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 146,
    answers: [{ value: 'Morderczynie' }],
    question:
      'Karolina to młoda i ambitna policjantka, która usiłuje odnaleźć zaginionego ojca. Podczas pozornie błahej interwencji Karolina trafia na ofiarę morderstwa. Wkrótce sprawa zaginięcia',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 147,
    answers: [{ value: 'Warszawianka' }],
    question:
      'Główny bohater Franek Czułkowski aka Czuły to postać złożona. Nieodpowiedzialny imprezowicz, przyjaciel wszystkich i seryjny uwodziciel. Jednocześnie zadręcza się nienawiścią',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 148,
    answers: [{ value: 'Sortownia' }],
    question:
  ...
  {
    id: 149,
    answers: [{ value: 'Lipowo. Zmowa milczenia' }],
    question:
      'W małym miasteczku mieszkańcy do perfekcji opanowali grę pozorów, a historię miejscowości od lat piszą sekrety oraz połączenie dwóch religijnych światów: pogańskiego i chrześcijańskiego.',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 150,
    answers: [{ value: 'Dziewczyna i kosmonauta' }],
    question:
      'Dwaj piloci F-16, przyjaciele Nikodem i Bogdan konkurują o serce pięknej Marty, oraz o to który z nich poleci w kosmos. Kosmiczną rywalizację wygrywa Nikodem, jednak z powodu niewyjaśnionej',
    hints: [],
    revealedAnswers: [],
  },
  {
    id: 151,
    answers: [{ value: 'Wielka woda' }],
    question:
