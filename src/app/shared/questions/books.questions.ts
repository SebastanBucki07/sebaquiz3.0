export const BOOKS = [
  ...
  },
  {
    ...
    question:
      'I milczenie było, tylko z dala ozwała się poranna muzyka lasów... Trąciło o nie skrzydło wiosennego powiewu i gałęzie grać zaczęły... Każde drzewo grało inaczej, a ucho mieszkańca puszcz rozeznać mogło',
    hints: [
      {
        id: '4-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Poranek wiosenny świtał nad czarną lasów ławą otaczającą widnokrąg dokoła. W powietrzu czuć było woń liści i traw młodych, zlanych rosą świeżo w ciągu kilku takich poranków z nabrzmiałych pączków rozwitych.',
        penaltyPercent: 20,
      },
      {
        id: '4-fragment3',
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 3',
        content:
          'Uamrł Gustaw, Neich żyje Konrad I sam nie wiesz, gdzie lecisz, sam nie wiesz, co zdziałasz.  \nLudzie! każdy z was mógłby, samotny, więziony,  \nMyślą i wiarą zwalać i podźwigać trony.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Jest niedziela, szkaradny dzień marcowy; zbliża się południe, lecz ulice Warszawy są prawie puste. Ludzie nie wychodzą z domów albo kryją się w bramach, albo skuleni uciekają przed siekącym ich deszczem i śniegiem.',
        penaltyPercent: 20,
      },
      {
        id: '9-fragment3',
        label: 'Fragment 3',
        content:
          'W tej samej porze, kiedy Wokulski z panią Wąsowską kłócił się albo galopował po łące, z majątku hrabiny do Zasławka dojeżdżała panna Izabela.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 3',
        content:
          'Wilhelmie! Człowiek, o którym ci pisałem, ów szczęśliwy biedak, był pisarzem u ojca Loty, zapałał ku niej namiętnością, ukrywał to, potem wyznał, został wydalony ze służby i oszalał.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  },
  {
    ...
    question:
      'mieścinie pewnej, prowincji Manchy, której nazwiska nie powiem, żył niedawnymi czasy hidalgo12 pewien, z liczby tych, co to prócz spisy13 u siodła, szabliska starego, szkapy chudziny i paru gończych, niewiele co więcej mają.',
    hints: [
      {
        id: '16-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Tak więc: Kareola, Lew w Hiszpanii, Wielkie czyny cesarza, dzieło Ludwika d’Avila, które znajdować się tam musiały, poniosły karę stosu, której może by uniknęły, gdyby proboszcz sprawy ich był rozpoznawał',
        penaltyPercent: 20,
      },
      {
        id: '16-fragment3',
        label: 'Fragment 3',
        content:
          'i jak je tylko spostrzegł, zawołał: „Fortuna sprzyja nam bardziej, niżbyśmy sami pragnęli. Przyjacielu Sancho, czy widzisz tę gromadę niezmiernych olbrzymów? Ja na nich uderzę i wszystkich zgładzę z tego świata — taki mój zamiar.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Ale dla wiatru las tajemnic nie ma. Są to dwaj przyjaciele. Przenika wiatr leśne gęstwiny od skraju do skraju i one mu wszystko, co widziały, słyszały, opowiadają.',
        penaltyPercent: 20,
      },
      {
        id: '17-fragment3',
  ...
  },
  {
    ...
    question:
      'Na ulicy Miodowej co dzień około południa można było spotkać jegomościa1 w pewnym wieku, który chodził z placu Krasińskich ku ulicy Senatorskiej.',
    hints: [
      {
        id: '21-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Zdarzyło się w tych czasach, że jeden z przyjaciół mecenasa miał proces i jak zwykle oddał mu do przejrzenia papiery z prośbą o radę. Wprawdzie pan Tomasz nie stawał już w sądach23,',
        penaltyPercent: 20,
      },
      {
        id: '21-fragment3',
  ...
  },
  {
    ...
    question:
      'Więc kiedy byłem taki, jak na tej fotografii1, sam chciałem zrobić to wszystko, co tu napisane. A potem zapomniałem, i teraz jestem stary.',
    hints: [
      {
        id: '22-fragment1',
        label: 'Fragment 1',
  ...
  },
  {
    ...
    question:
      'W Tyńcu, w gospodzie „Pod Lutym2 Turem3”, należącej do opactwa, siedziało kilku ludzi, słuchając opowiadania wojaka bywalca, który z dalekich stron przybywszy, prawił im o przygodach, jakich na wojnie i w czasie podróży doznał.',
    hints: [
      {
        id: '23-fragment1',
        label: 'Fragment 1',
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Zaczęły płynąć godziny, dnie i tygodnie... Majtkowie twierdzą, że czasem, gdy morze bardzo jest rozhukane, woła coś na nich wśród nocy i ciemności po nazwisku.',
        penaltyPercent: 20,
      },
      {
        id: '24-fragment3',
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Justyna patrzała na żywe jego ruchy, którym kształtność ciała nadawała szczególną zręczność i giętkość; nie mogła też nie spostrzec, że z błękitnych, roziskrzonych oczu, zza zmieszania i zawstydzenia, wybuchała mu tajemna, lecz nie dająca utaić się radość.\n\n— Pan Jan Bohatyrowicz? — trochę nieśmiało zapytała.',
        penaltyPercent: 20,
      },
      {
        id: '27-fragment3',
  ...
  },
  {
    ...
    question:
      'Cóż to, nadobna Elizo zapadłaś, widzę, w smutek po chwili serdecznego zapału, który sprawił, iż tak wspaniałomyślnie oddałaś mi wiarę i słowo? Wzdychasz, gdy ja jestem tak pełen radości!',
    hints: [
      {
        id: '29-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Nie, Dokładnych wiadomości nie mógłbym udzielić; wszedłem z nim w styczność jedynie przypadkiem; ale on sam dostarczy panu wyjaśnień. Służący upewniał mnie, że pan będzie zupełnie zadowolony. Wszystko, co mógłbym powiedzieć, to, iż pochodzi z rodziny bardzo bogatej, matka już nie żyje, gotów zaś jest zobowiązać się, jeżeli pan zechce, iż ojciec umrze przed upływem ośmiu miesięcy.',
        penaltyPercent: 20,
      },
      {
        id: '29-fragment3',
  ...
  },
  {
    ...
    question:
      'Gdy z portu wracał do domu z matką, zaiste, jak grób milczącą, był już wesoły. Pocieszyło go to i owo, a nade wszystko perspektywa swobody. Ojciec, który go nigdy a nigdy nie karał, nigdy nawet nie łajał, a strofował półżartem, z lekką drwinką, dowcipkując, posiadał nad synem władzę żelazną, niezłomną.',
    hints: [
      {
        id: '30-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 3',
        content:
          'Seweryn Baryka nie pokonał Niemców nad Mazurskimi Jeziorami. Przeciwnie — wiał na wschód z resztą armii. Długo nie było od niego wieści, a gdy wreszcie nadeszła, to już zupełnie skądinąd. Był w Karpatach',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  },
  {
    ...
    question:
      'Nadszedł sobotni ranek. Słońce świeciło promiennie, cały świat dyszał radością lata i kipiał życiem. W każdym sercu dźwięczała muzyka, a jeśli serce było młode, pieśń sama cisnęła się na usta.',
    hints: [
      {
        id: '31-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Starsza pani zsunęła okulary na nos i rozejrzała się po pokoju ponad szkłami; potem podniosła je na czoło i rozejrzała się ponownie. Dla takiego drobiazgu jak Tomek, patrzyła przez okulary rzadko — prawie nigdy.',
        penaltyPercent: 20,
      },
      {
        id: '31-fragment3',
        label: 'Fragment 3',
        content:
          'Tomek stanął przed ciotką Polly. Siedziała przy otwartym oknie przytulnego, zacisznego pokoju, który był jednocześnie sypialnią, jadalnią, bawialnią i czytelnią.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  },
  {
    ...
    question:
      'Petroniusz1 obudził się zaledwie koło południa i jak zwykle, zmęczony bardzo. Poprzedniego dnia był na uczcie u Nerona2, która przeciągnęła się do późna w noc.',
    hints: [
      {
        id: '32-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Tej nocy Winicjusz nie kładł się wcale. W czas jakiś po odejściu Petroniusza, gdy jęki smaganych niewolników nie mogły ukoić ani jego bólu, ani wściekłości, zebrał gromadę innych sług i na ich czele późną już nocą wypadł na poszukiwanie Ligii.',
        penaltyPercent: 20,
      },
      {
        id: '32-fragment3',
        label: 'Fragment 3',
        content:
          'Wiadomo było w Rzymie, że cezar chce odwiedzić po drodze Ostię, a raczej największy statek na świecie, który świeżo przywiózł był zboże z Aleksandrii, stamtąd zaś drogą Pobrzeżną369 uda się do Ancjum.',
        penaltyPercent: 40,
      },
    ],
    revealedAnswers: [],
  ...
  },
  {
    ...
    question:
      'cena przedstawia salon w burżuazyjnym domu. — Dywany — meble solidne — na ścianach w złoconych ramach premia i Bóg wie jakie obrazy. — Rogi obfitości — sztuczne palmy — landszaft haftowany za szkłem. — Pomiędzy tym stara, piękna serwantka mahoniowa i empirowy ekranik. — Lampa z abażurem z bibuły — stoliki, a na nich fotografie.',
    hints: [
      {
        id: '36-fragment1',
        label: 'Fragment 1',
  ...
  },
  {
    ...
    question:
      'Nie posłał mnie Chrystus, abym chrzci, lecz abym głosił Ewangelię, i to nie w mądrości słowa, by nie zniweczyć Chrystusowego krzyża.',
    hints: [
      {
        id: '39-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'a początku Bóg stworzył niebo i ziemię. 2 Ziemia zaś była bezładem i pustkowiem: ciemność była nad powierzchnią bezmiaru wód, a Duch2 Boży unosił się nad wodami.',
        penaltyPercent: 20,
      },
      {
        id: '39-fragment3',
  ...
  },
  {
    ...
    question:
      'Rozpalenie nowego ognia było aktem bardzo uroczystym. Dokonywano tego przez pocieranie dwóch kawałków drzewa, czyli sposobem najbardziej pierwotnym, sięgającym epoki kamiennej, a spotykanym dziś u ludów zaszytych w ustronia ziemi, dokąd jeszcze nie dotarła cywilizacja.',
    hints: [
      {
        id: '40-fragment1',
        label: 'Fragment 1',
      ...
      },
      {
        ...
        label: 'Fragment 2',
        content:
          'Najszerzej rozwinął się irański kult Mitry. Legiony rzymskie, gdzie miał najwięcej wyznawców, zaniosły go nad Dunaj i do lasów Germanii, na piaskach Afryki i wśród mgieł Brytanii stanęły ołtarze tego boga światłości. Zwał się Sol Invictus — Słońce Niezwyciężone.',
        penaltyPercent: 20,
      },
      {
        id: '40-fragment3',
