    ...
    hints: [
      {
        ...
        penaltyPercent: 0,
        content:
          'Śród takich pól przed laty, nad brzegiem ruczaju6, Na pagórku niewielkim, we brzozowym gaju, Stał dwór szlachecki, z drzewa, lecz podmurowany;  Świeciły się z daleka pobielane ściany,"',
      },
      {
        id: 'second',
